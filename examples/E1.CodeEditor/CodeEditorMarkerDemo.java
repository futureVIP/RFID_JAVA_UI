...
/**
 * Demoed Component: {@link com.jidesoft.editor.CodeEditor} <br> Required jar files: jide-common.jar, jide-editor.jar, jide-components.jar, jide-shortcut.jar, jide-editor.jar <br> Required L&F: any
 * L&F
 */
    ...
    public Component getOptionsPanel() {
        ...
        checkBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                Object[] markers = _editor.getMarkerModel().getMarkers().toArray();
                for (Object marker : markers) {
                    ((Marker) marker).setEnabled(e.getStateChange() == ItemEvent.SELECTED);
                }
            }
        });
    ...
    public Component getDemoPanel() {
        ...
        try {
            ...
            while (fromIndex < string.length()) {
                ...
                fromIndex = index + 8;
                _editor.getMarkerModel().addMarker(index, fromIndex - 1, Marker.TYPE_CUSTOM_STYLE, "We make you love being a Swing developer.");
            }
            ...
            _editor.getStyles().addStyle(Marker.TYPE_CUSTOM_STYLE, style);
