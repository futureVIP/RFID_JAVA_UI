/*
 * @(#)CalculatedPivotTableDemo.java 3/18/2010
 *
...
import com.jidesoft.hssf.CsvPivotTableUtils;
 ...
 */
public class CalculatedPivotTableDemo extends AbstractDemo {
    ...
    public CalculatedPivotTableDemo() {
    }

    public String getName() {
        return "Calculated Pivot Grid Demo";
    }
    ...
    public String getDescription() {
        return "This demo looks exactly the same with PivotTableDemo\n" +
                "The only difference is that this demo uses CalculatedPivotDataModel, which makes running summary available.\n" +
                "You could popup the field setting panel for the data fields to add running summary.\n" +
                "Comparing to PivotTableDemo, you would find there is only one line change to have this new feature.\n" +
                "Demoed classes:\n" +
    ...
    public Component getOptionsPanel() {
        ...
        final JButton getRowButton = new JButton(new AbstractAction("Get Row Expansion State") {
            private static final long serialVersionUID = 780187065789416759L;
        ...
        final JButton setRowButton = new JButton(new AbstractAction("Set Row Expansion State") {
            private static final long serialVersionUID = -6544192340690574000L;
        ...
        final JButton getColumnButton = new JButton(new AbstractAction("Get Column Expansion State") {
            private static final long serialVersionUID = -3534778691452623838L;
        ...
        final JButton setColumnButton = new JButton(new AbstractAction("Set Column Expansion State") {
            private static final long serialVersionUID = -7540724134806027039L;
...
//        final PivotDataModel pivotDataModel = new PivotDataModel(new CachedTableModel(derivedTableModel));
        final CalculatedPivotDataModel pivotDataModel = new CalculatedPivotDataModel(derivedTableModel);
...
//        System.out.println(System.currentTimeMillis() - start);
    ...
    static public void main(String[] s) {
        ...
        showAsFrame(new CalculatedPivotTableDemo());
    }
