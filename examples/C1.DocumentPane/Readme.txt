...
src\                        source code directory (only if you purchased source code license)
    ...
    src-charts.zip          source code zip file for JIDE Charts
    src-gantt.zip           source code zip file for JIDE Gantt Chart
    src-diff.zip            source code zip file for JIDE Diff
license\
...
using Java technology. Founded in 2002, JIDE Software has developed 16 products and over 100 professional
Swing components that cover almost every aspect of Java/Swing development.

With more than 1500 customers in over 40 countries worldwide, JIDE Software is the clear market leader.
