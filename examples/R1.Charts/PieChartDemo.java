...
public class PieChartDemo extends AbstractDemo {
    ...
    private ButtonGroup segmentButtonGroup;
    private ButtonGroup labelButtonGroup;
    private static Highlight redHighlight, greenHighlight, blueHighlight;
    ...
    private JRadioButton lineLabelsRadioButton, simpleLabelsRadioButton, noLabelsRadioButton;
    ...
    private JPanel createDemo() {
        ...
        segmentButtonGroup = new ButtonGroup();
        labelButtonGroup = new ButtonGroup();
        redHighlight = new Highlight("Red");
        greenHighlight = new Highlight("Green");
        blueHighlight = new Highlight("Blue");
        ...
        colors = new CategoryRange<String>().add(red).add(green).add(blue);
        ...
        noLabelsRadioButton = new JRadioButton("No Labels");
