...
public class IPTextFieldDemo extends AbstractDemo {
    private static final long serialVersionUID = 3738139943424639500L;
...
//    }
    ...
    public Component getDemoPanel() {
        ...
        final IPTextField maskTextField = new IPTextField();
        panel.add(new JLabel("Class B Mask: "));
        panel.add(Box.createVerticalStrut(GAP));
        maskTextField.setSubnetMask("255.255.0.0");
        panel.add(maskTextField);
        panel.add(Box.createVerticalStrut(GAP * 2));
        maskTextField.addFocusListener(new FocusListener() {
            public void focusGained(FocusEvent e) {
            }

            public void focusLost(FocusEvent e) {
                String[] rawTexts = maskTextField.getRawText();
