 ...
 */
public class DockDemo extends AbstractDemo {
    public String getName() {
        return "Docking Framework Demo";
    }
    ...
    public Component getDemoPanel() {
        ...
        buttonPanel.addButton(new JButton(new AbstractAction("Launch DockingFramework Demo") {
            public void actionPerformed(ActionEvent e) {
                DockingFrameworkDemo.showDemo(false);
            }
        }));
    ...
    public String[] getDemoSource() {
        return new String[]{"DockingFrameworkDemo.java"};
    }

    public static void main(String[] args) {
        LookAndFeelFactory.installDefaultLookAndFeelAndExtension();
        showAsFrame(new DockDemo());
    }
}
