...
public class RangeSliderDemo extends AbstractDemo {
    ...
    public Component getOptionsPanel() {
        ...
        final JCheckBox option5 = new JCheckBox("RangeDraggable");

        JPanel switchPanel = new JPanel(new GridLayout(5, 1, 3, 3));
        ...
        option5.setSelected(_rangeSlider.isRangeDraggable());
        option5.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _rangeSlider.setRangeDraggable(option5.isSelected());
            }
        });
