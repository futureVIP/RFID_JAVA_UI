...
//        panel.setFont(new Font("Tahoma", Font.BOLD, 30));
    ...
    protected Component createOptionPanel() {
        ...
        panel.add(Box.createVerticalStrut(12), JideBoxLayout.FIX);
        final JCheckBox todayCheckBox = (JCheckBox) panel.add(new JCheckBox("Show Today/Now Button"));
        ...
        final JCheckBox showMonthMenuCheckBox = (JCheckBox) panel.add(new JCheckBox("Show Month Popup Menu"));
        showMonthMenuCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _dateChooserPanel.setShowMonthMenu(showMonthMenuCheckBox.isSelected());
            }
        });
        showMonthMenuCheckBox.setSelected(_dateChooserPanel.isShowMonthMenu());
        panel.add(Box.createVerticalStrut(6), JideBoxLayout.FIX);
        ...
        final JCheckBox timeDisplayCheckBox = (JCheckBox) panel.add(new JCheckBox("Display Time"));
        timeDisplayCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _dateChooserPanel.setTimeDisplayed(timeDisplayCheckBox.isSelected());
            }
        });
        timeDisplayCheckBox.setSelected(_dateChooserPanel.isTimeDisplayed());
        panel.add(Box.createVerticalStrut(6), JideBoxLayout.FIX);
