...
public class AutoResizeModeDemo extends AbstractDemo {
    ...
    public Component getOptionsPanel() {
        ...
        final JCheckBox fillWithStripe = new JCheckBox("Fill With Stripe");
        fillWithStripe.addItemListener(new ItemListener() {
        ...
        fillWithStripe.setSelected(_table.isFillsViewportWithStripe());
        ...
        autoResizeMode.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                ...
                if (e.getItem().equals("Auto Resize Off")) {
                    ...
                    fillWithStripe.setEnabled(false);
                }
                    ...
                    fillWithStripe.setEnabled(true);
                }
            }
        });

        panel.add(autoResizeMode);
        panel.add(fillWithStripe);
        return panel;
    }
